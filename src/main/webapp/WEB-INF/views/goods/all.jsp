...
<body>
	...
	<div class="content">
		<div class="form-inline"
			style="position: fixed; right: 20px; top: 90px; z-index: 2;">
		...
		<div class="row goods" align="center">
			<c:forEach var="g" items="${goods}">
				<div class="scale col-lg-3 col-md-4 float-start" align="center">
					<a href="goods.detail?goods_id=${g.goods_id }" class="thumbnail">
						<img src="resources/img/${g.goods_img }" class="img-thumbnail"
						alt="Thumbnail image"
						style="width: 250px; height: 200px; margin: 20px;">
					</a>
					<h3>${g.goods_name}</h3>
					<h3>${g.goods_price}<span>원</span>
					</h3>
